...
const Contact = () => {
  return (
    <fieldset className="lg:w-2/4 m-auto mt-10 p-2 md:p-5 md:shadow">
      <legend className="text-2xl font-bold text-green-500 drop-shadow">Tell us your problem </legend>
      <form  className=" flex flex-col  gap-4">
        ...
        <button type="submit" className="bg-green-500 hover:bg-green-600 text-white font-bold text-xl py-2">Send your message</button>
